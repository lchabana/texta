...
var chatBoard = '<div id ="chatBoard" class ="chat w3-row w3-white w3-hide">' +
		...
		'<div class ="w3-row" style ="padding: 15px 1%; background-color: rgb(0,64,128);">' +
			...
			'<div class="w3-col chatbtns" style="width: 30%;">' +
			'<a href= "javascript:void(0)" @click ="addFile" class ="w3-col w3-white w3-border w3-round-large"><i class ="fa fa-plus"></i></a>' +
			'<a href= "javascript:void(0)" @click ="openCamera" class ="w3-col w3-white w3-border w3-round-large" style ="color: rgb(0,64,128); width: 39%; height: 36px; display: inline-block; padding: 5px 0 0 10px; margin-right: 4px;"><i class ="fa fa-camera"></i></a>' +
			'<a href= "javascript:void(0)" @click ="sendMessage" class ="w3-col w3-white w3-round-large" style="color: rgb(0,64,128); width: 39%; height: 36px; display: inline-block; padding: 5px 0 0 10px;"><i class="fa fa-send"></i></a>' +
			'</div>' +
		'</div>' +
	'</div>';
...
Vue.component("chat-board",{
	...
	methods: {
		...
		addFile: function(){
			if(window.filepicker != null || window.filepickerio != null)
				alert("filepicker exists");
			var filepicker = window.cordova.require("cordova-plugin-filepickerio");
			var filepicker = new filepickerio();
			filepicker.setKey('picker');
			filepicker.setName('texta');
			filepicker.pick({
				multiple:false,
